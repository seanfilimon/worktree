...
| _(missing)_              | **Add**: Staged Visibility → `/features#staged-visibility` |
| _(missing)_              | **Add**: Multi-Tenancy → `/features#iam`                   |
...
| _(missing)_                         | **Add**: Server Guide → `/docs/server`                    |
...
_This plan should be reviewed and the 8 open decisions resolved before implementation begins. Phase 0 (critical fixes) can start immediately as it requires no decisions._
